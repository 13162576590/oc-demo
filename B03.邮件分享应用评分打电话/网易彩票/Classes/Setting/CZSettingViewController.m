...
//    group1.headerTitle = @"bbbb";
    ...
    CZSettingItem *item5 = [CZSettingArrowItem itemWithIcon:@"handShake" title:@"帮助" vcClass:[CZHelpViewController class]];
    
    CZSettingItem *item6 = [CZSettingArrowItem itemWithIcon:@"handShake" title:@"分享" vcClass:[CZShareViewController class]];
    
    CZSettingItem *item7 = [CZSettingArrowItem itemWithIcon:@"handShake" title:@"查看消息"];
    
    CZSettingItem *item8 = [CZSettingArrowItem itemWithIcon:@"handShake" title:@"产品推荐"vcClass:[CZProductsShareViewController class]];
    
    CZSettingItem *item9 = [CZSettingArrowItem itemWithIcon:@"handShake" title:@"关于" vcClass:[CZAboutViewController class]];
